...
class Research(object):
    def __init__(self, ticker1, num=10, type=0, host='47.52.224.156', user='hhui', passwd='hhui123456', db_name='db_corr'):
        self.type = type
    ...
    def load_data(self, tickerlst, daylst, period, file_dir='/media/charles/charles_13162398828/hdd/output/price/'):   # 直接读取price,return数据，可选period是0s,1s,5s
    ...
    def load_price(self, daylst, file_dir='/media/charles/charles_13162398828/hdd/output/price/'):
        res = pd.DataFrame()
        for day in daylst:
            single_day = pd.DataFrame()
            try:
